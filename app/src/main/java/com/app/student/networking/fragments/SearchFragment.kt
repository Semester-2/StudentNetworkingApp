...
class SearchFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        searchEditText!!.addTextChangedListener(object : TextWatcher {
            ...
            //Live search, as the user types the characters
    ...
    //Retrieve all users available, unless the user types somethng in the search box, then start search character-wise
