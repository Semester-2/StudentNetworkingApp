...
class MyFirebaseMessaging: FirebaseMessagingService()
{
    ...
    private fun sendOreoNotification(mRemoteMessage: RemoteMessage) {
        ...
        val oreoNotification = OeroNotification(this)

        val buider: Notification.Builder = oreoNotification.getOreoNotification(title, body, pendingIntent, defaultSound, icon)
        ...
        oreoNotification.getManager!!.notify(i, buider.build())
